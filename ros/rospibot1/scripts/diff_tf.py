...
class DiffTf:
    ...
    def __init__(self):
        ...
        self.ticks_meter = float(rospy.get_param('ticks_meter', 8988))  # The number of wheel encoder ticks per meter of travel
	...
	self.odom_frame_id = "/odom"
        ...
        # subscriptions
        rospy.Subscriber("encl", Int32, self.lwheelCallback)
        rospy.Subscriber("encr", Int32, self.rwheelCallback)
