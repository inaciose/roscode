...
ros::Publisher imu_data1("imu1", &imu_msg1);

std_msgs::Float32 imu_msg2;
ros::Publisher imu_data2("imu2", &imu_msg2);

std_msgs::Float32 imu_msg3;
ros::Publisher imu_data3("imu3", &imu_msg3);

std_msgs::Float32 imu_msg4;
ros::Publisher imu_data4("imu4", &imu_msg4);
...
//        ;    
  ...
  if ((mpuIntStatus & 0x10) || fifoCount > 512) {
    ...
    fifoCount -= packetSize;
        ...
        imu_msg1.data = q.x;
        imu_data1.publish(&imu_msg1); 

        imu_msg2.data = q.y;
        imu_data2.publish(&imu_msg2); 
        
        imu_msg3.data = q.z;
        imu_data3.publish(&imu_msg3); 

        imu_msg4.data = q.w;
        imu_data4.publish(&imu_msg4);
