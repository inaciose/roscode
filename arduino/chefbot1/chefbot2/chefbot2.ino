...
#define BATTERY_SENSE_PIN A6 // not implemented
...
////////////////////////////////////////////////////////////////
// timers
#define ULTRASONIC_DELAY 30
#define ENCODER_DELAY 30
#define TIME_DELAY 30
#define BATTERY_DELAY 30
...
//  SetupReset();
  ...
  ultrasonicTimer = millis() + ULTRASONIC_DELAY;
encoderTimer = millis() + ENCODER_DELAY;
timeTimer = millis() + TIME_DELAY;
...
void moveLeftMotor(float rightServoValue) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void moveRightMotor(float leftServoValue) {
 if (leftServoValue > 0) {
