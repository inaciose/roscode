...
enum e_baseMotionStates { MOTION_IDLE, MOTION_FORWARD, MOTION_BACKWARD, MOTION_ROTATE_LEFT, MOTION_ROTATE_RIGHT, MOTION_FORWARD_CURVE_LEFT, MOTION_FORWARD_CURVE_RIGHT, MOTION_BACKWARD_CURVE_LEFT, MOTION_BACKWARD_CURVE_RIGHT};
