...
#define STEERING_PID_SAMPLE_TIME 25 // 5
...
#define LEFT_SPEED_PID_MAX_OUTPUT 200
...
#define RIGHT_SPEED_PID_MIN_OUTPUT 30
#define RIGHT_SPEED_PID_MAX_OUTPUT 200
...
double minPidVel = 0.60;
double maxPidVel = 1.60;
