//
// added: int32 or flot32 multiarray messages
//
// doesnt work
//
...
//std_msgs::Int32MultiArray timeArray;
//ros::Publisher time_rospub1("time", &timeArray);

std_msgs::Int32MultiArray timeArray;
//std_msgs::Float32MultiArray timeArray;
ros::Publisher time_rospub1("time", &timeArray);
...
void loop() {
  ...
  if(millis() >= tf_publisher_timer) {
    ...
    // timeArray ros topic publisher
    timeArray.data[0] = (long)SecondsSinceLastUpdate;
    timeArray.data[1] = (long)LastUpdateMicrosecs;
    //time_rospub1.publish(&timeArray);
  }
