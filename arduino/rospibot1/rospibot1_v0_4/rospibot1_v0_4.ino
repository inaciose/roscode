// rospibot 0.4
// done: failed
// try: led pulse, diag and looptime messages
// not working

//#define ROS_TOPIC_LOOPTIME
//#define ROS_TOPIC_DIAG
...
#ifdef ROS_TOPIC_DIAG
  // diagnostic publishers
  std_msgs::String diag_msg1;
  ros::Publisher diag_rospub1("diag1", &diag_msg1);
  char hello[13] = "hello world!";
#endif

#ifdef ROS_TOPIC_LOOPTIME
unsigned long loopTimeLast;
unsigned long looptime;
// looptime publisher
std_msgs::Int32 looptime_msg1;
ros::Publisher looptime_rospub1("looptime", &looptime_msg1);
#endif
...
void setup() {
  ...
  // ros init and topic registration
  nh.initNode();
  ...
  #endif
  #ifdef ROS_TOPIC_DIAG
    nh.advertise(diag_rospub1);
  #endif
  #ifdef ROS_TOPIC_LOOPTIME
    nh.advertise(looptime_rospub1);
    loopTimeLast = millis();
  #endif
...
void loop() {
  ...
  #ifdef ROS_TOPIC_LOOPTIME
    looptime = millis();
    // looptime ros topic publisher
    looptime_msg1.data = looptime - loopTimeLast;
    looptime_rospub1.publish(&looptime_msg1);
    // set new looptimeLast   
  ...
  //diag_msg1.data = hello;
  //diag_rospub1.publish( &diag_msg1 );
}
